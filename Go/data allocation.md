...
**New and make**
Well, Go has two types of memory allocation primitives. These are `new(type)` and `make(type,args)`. Let's read through the Go docs and see what we make of those.
